      ...
      <template v-slot:after>
        ...
        >
            ...
            <div class="column">
              ...
              <div class="col-1" v-if="configType === 'request'">
                <q-input
                  ...
                  :rules="[
                    (val) =>
                      (val && val.length > 0) ||
                      'Please fill Request Destination URL',
                  ]"
                  @input="emitValue"
                />
              ...
              <div class="col-1" v-if="configType === 'request'">
                <q-select
                  ...
                  :rules="[
                    (val) =>
                      (val && val.length > 0) || 'Please fill Request Method',
                  ]"
                  style="max-width: 200px"
                />
          ...
          <q-tab-panel name="Adds.Body">
            ...
            <Editor
              v-model="data.codeAddBody"
              :event-name="'on-change-add-body'"
              @input="emitValue"
              ref="codeAddBody"
            />
          </q-tab-panel>

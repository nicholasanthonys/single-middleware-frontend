          ...
          <template v-slot:body="props">
            <q-tr :props="props">
              <q-td v-for="col in props.cols" :key="col.name" :props="props">
                <p v-if="col.name !== 'action' && col.name !== 'description'">
                  {{ col.value }}
                </p>
      ...
      >
        <q-card>
          <q-card-section class="row items-center">
            ...
            <span class="q-ml-sm"
              >Are you sure want to delete configure with id
              {{ selectedConfig.id }} ?
            </span>
          </q-card-section>
          ...
          <q-card-actions align="right">
            ...
            <q-btn
              ...
              label="Delete"
              color="primary"
              :loading="isDeletingConfigure"
              @click="deleteConfigure($route.params.id, selectedConfig.id)"
            />
          </q-card-actions>
        </q-card>
      </q-dialog>

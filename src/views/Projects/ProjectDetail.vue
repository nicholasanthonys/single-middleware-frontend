              ...
              >
                <q-tab-panel name="general">
                  ...
                  <q-input
                    ...
                    :rules="[
                      (val) =>
                        (val && val.length > 0) || 'Please type Project Name',
                    ]"
                    name="name"
                    ref="name"
                  />
                ...
                <q-tab-panel name="base">
                  ...
                  <q-input
                    ...
                    :rules="[
                      (val) =>
                        (val && val > 0) ||
                        'Please specify max circular request',
                    ]"
                    filled
                  />
                ...
                >
                  <Configures
                    ...
                    :prop-configs="configs"
                    v-if="!isLoadConfigures"
                  />
                  <div
                    style="height: 100%"
                    v-else
...
export default {
  ...
  data() {
    return {
      ...
      tabNames:
        this.$route.name === "Project.New"
          ? ["general", "base"]
          : ["general", "base", "configures", "serial/parallel"],
    };
  },
  methods: {
    ...mapActions({
      ...
      return {
        ...
        base: {
          ...
          circular_response: {
            ...
            log_before_modify: this.editorData.logBeforeModify
              ? this.editorData.logBeforeModify
              : {},
            log_after_modify: this.editorData.logAfterModify
              ? this.editorData.logAfterModify
              : {},
            adds: {
